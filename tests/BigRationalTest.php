...
class BigRationalTest extends AbstractTestCase
{
    ...
    {
        $this->expectException(DenominatorMustNotBeZeroException::class);
        BigRational::nd(1, 0);
    }
    ...
    /**
     * @param string $number   The number to clamp.
    ...
    public function testIsOne(string $number, bool $expected): void
    {
        self::assertSame($expected, BigRational::of($number)->isOne());
    }
    ...
    public static function providerIsOne(): array
    {
        return [
            ...
            ['1/2', false],
            ['2/1', false],
            ['999999999999999999999999999999/999999999999999999999999999999', true],
        ];
    }
     ...
     * @param string $numerator   The numerator.
     * @param string $denominator The denominator.
     * @param string $expected    The expected decimal period output.
     */
    #[DataProvider('providerToDecimalPeriod')]
    public function testToDecimalPeriod(string $numerator, string $denominator, string $expected): void
    {
        $rational = BigRational::nd($numerator, $denominator);
        self::assertSame($expected, $rational->toDecimalPeriod());
    }

    public static function providerToDecimalPeriod(): array
    {
        return [
            // Integers
            ['5', '1', '5'],
            ...
            // Simple repeating decimals (pure repeating)
            ['1', '3', '0.(3)'],
            ['2', '3', '0.(6)'],
            ['1', '9', '0.(1)'],
            ['8', '9', '0.(8)'],
            ...
            // Mixed non-repeating and repeating parts
            ['1', '6', '0.1(6)'],
            ['5', '6', '0.8(3)'],
            ['7', '12', '0.58(3)'],
            ['1', '12', '0.08(3)'],
            ...
            // With larger integer part
            ['22', '7', '3.(142857)'],
            ['100', '3', '33.(3)'],
            ['1000', '7', '142.(857142)'],

            // Edge cases with simplification
            ['2', '6', '0.(3)'], // simplifies to 1/3
            ['4', '12', '0.(3)'], // simplifies to 1/3
            ['6', '4', '1.5'], // simplifies to 3/2

            // Negative numbers
            ['-1', '3', '-0.(3)'],
            ['-171', '70', '-2.4(428571)'],
            ['1', '-3', '-0.(3)'], // negative denominator
        ];
    }
}
